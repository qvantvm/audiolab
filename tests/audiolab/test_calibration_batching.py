...
from audiolab.autoresearch.calibration_plan import run_phrase_targeted_calibration
...
def test_run_phrase_targeted_calibration_uses_trial_batches(
    ...
    monkeypatch.setattr(
        "audiolab.autoresearch.calibration_plan._evaluate_trial_batch",
        fake_batch,
    )
    monkeypatch.setattr(
        "audiolab.autoresearch.calibration_plan._evaluate_phrase_panel",
