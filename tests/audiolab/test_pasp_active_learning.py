...
from audiolab.autoresearch.experiment_design.candidate_generator import (
    generate_all_candidates,
    generate_candidates_for_cluster,
)
from audiolab.autoresearch.experiment_design.config import ActiveLearningConfig
from audiolab.autoresearch.experiment_design.coverage import analyze_dataset_coverage
from audiolab.autoresearch.experiment_design.cost_model import compute_cost_penalty
from audiolab.autoresearch.experiment_design.manifest_augmentation import (
    apply_manifest_additions,
    build_proposed_items,
)
from audiolab.autoresearch.experiment_design.recording_tasks import build_recording_tasks
from audiolab.autoresearch.experiment_design.reports import build_active_learning_summary
from audiolab.autoresearch.experiment_design.run import load_active_learning_summary, run_active_learning
from audiolab.autoresearch.experiment_design.scoring import score_candidate
from audiolab.autoresearch.experiment_design.synthetic_probes import write_synthetic_probes
