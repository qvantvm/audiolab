...
from audiolab.autoresearch.memory.hypothesis_tags import infer_hypothesis_tags
from audiolab.autoresearch.memory.ingest import ingest_cycle_dir, ingest_cycles_root
...
from audiolab.autoresearch.memory.similarity import compute_cycle_similarity, rank_similar_cycles
