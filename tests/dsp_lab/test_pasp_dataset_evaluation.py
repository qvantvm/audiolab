...
from dsp_lab.evaluation.agent_report import build_agent_report
...
from dsp_lab.evaluation.failure_tags import tag_failures
...
def test_duplicate_item_ids_rejected() -> None:
    from dsp_lab.evaluation.dataset_manifest import DatasetItem
