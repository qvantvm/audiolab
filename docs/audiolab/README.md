...
PYTHONPATH=src python -m pytest tests/audiolab/test_pasp_autoresearch_loop.py -q
PYTHONPATH=src python -m pytest tests/audiolab/test_pasp_llm_planner.py -q
PYTHONPATH=src python -m pytest tests/audiolab/test_pasp_experiment_memory.py -q
PYTHONPATH=src python -m pytest tests/audiolab/test_pasp_active_learning.py -q
PYTHONPATH=src python -m pytest tests/audiolab/test_pasp_model_governance.py -q
```
