...
| [`run_autoresearch_harness.py`](../../examples/run_autoresearch_harness.py) | `dsp_lab` harness | Harness entry: baseline, plan, full, promote |
| [`smoke_pasp_autoresearch.py`](../../examples/smoke_pasp_autoresearch.py) | — | No-agent green-path smoke test |
| [`run_pasp_autoresearch_cycle.py`](../../examples/run_pasp_autoresearch_cycle.py) | `dsp_lab.autoresearch.run_cycle` | Closed-loop research cycle |
| [`run_pasp_dataset_eval.py`](../../examples/run_pasp_dataset_eval.py) | `dsp_lab.evaluation.run_pasp_dataset` | Batch manifest evaluation |
| [`rebuild_autoresearch_memory.py`](../../examples/rebuild_autoresearch_memory.py) | `dsp_lab.autoresearch.memory.build` | Rebuild memory JSONL from cycles |
| [`run_pasp_active_learning.py`](../../examples/run_pasp_active_learning.py) | `dsp_lab.autoresearch.experiment_design.run` | Coverage + next-experiment recommendations |
| [`register_pasp_model_candidate.py`](../../examples/register_pasp_model_candidate.py) | `dsp_lab.governance.register_candidate` | Register cycle candidate in model registry |
