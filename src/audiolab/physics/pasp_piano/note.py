...
from audiolab.physics.pasp_piano.string_group import BidirectionalStringGroupModel, StringGroupDiagnostics
...
from audiolab.physics.pasp_piano.params import resolve_contact_model, resolve_pasp_params
...
class PASPNoteModelCore:
    ...
    def _render_coupled(
        ...
        from audiolab.physics.pasp_piano.params import resolve_f0
