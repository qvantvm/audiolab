...
import audiolab.blocks  # noqa: F401 - imports register built-in blocks
from audiolab.blocks.metadata import get_port_spec, ports_compatible
from audiolab.blocks.registry import BLOCK_REGISTRY, validate_node
