...
import audiolab.blocks  # noqa: F401 - bootstrap built-in registry
from audiolab.blocks.base import DSPBlock
from audiolab.blocks.registry import get_block_class
from audiolab.graph.connections import classify_connection, scheduling_edges
...
from audiolab.graph.physical.computation import (
    assert_no_misclassified_physical_edges,
    assert_physical_computation_supported,
)
import audiolab.graph.physical.solvers  # noqa: F401 - register built-in physical solvers
from audiolab.graph.physical.registry import SolverRegistry, get_default_solver_registry
from audiolab.graph.physical.solver import CompiledPhysicalSubsystem
from audiolab.graph.physical.subsystem import PhysicalSubsystem, subsystem_trigger_block
...
from audiolab.graph.validator import split_endpoint, validate_graph
