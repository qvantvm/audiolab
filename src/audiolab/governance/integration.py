...
from audiolab.governance.promotion_gates import evaluate_promotion_gates, failed_gates
...
from audiolab.governance.reports import write_registry_reports
    ...
    *,
    ...
    if model_id:
        result["rollback_command"] = (
            f"PYTHONPATH=src python -m audiolab.governance.rollback_model "
