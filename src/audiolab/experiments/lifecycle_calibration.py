...
from audiolab.audio.metrics.lifecycle_metrics import compute_lifecycle_metrics
from audiolab.audio.metrics.lifecycle_plausibility import compute_lifecycle_plausibility_penalty
