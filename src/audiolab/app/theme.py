...
from audiolab.app.colors import (
    PANEL_BG,
    PANEL_BG_CONTENT,
    PANEL_BG_ELEVATED,
    PANEL_BORDER,
...
ACCENT = "#2f81f7"
_THEME_FLAG = "_audiolab_theme_applied"
...
#AudiolabPanelNav QToolButton:hover {{
    background: {PANEL_BG_ELEVATED};
}}
#AudiolabPanelNav QToolButton:checked {{
    background: {PANEL_BG_ELEVATED};
    border: 1px solid {PANEL_BORDER};
}}
#AudiolabPanelStack {{
...
#AudiolabPanelNavRoot #AudiolabPanelStack > QWidget {{
    background: {PANEL_BG_CONTENT};
}}
"""
