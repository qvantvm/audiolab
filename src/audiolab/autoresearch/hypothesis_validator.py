...
from audiolab.autoresearch.proposal_schema import KNOWN_OBJECTIVE_METRICS
from audiolab.autoresearch.topology_templates import resolve_topology_template
...
def validate_structured_hypothesis(
    ...
    *,
    ...
    if tier_norm >= 2 and template_id and repo_root is not None:
        try:
            from audiolab.autoresearch.topology_templates import main_block_id_from_graph_dict
