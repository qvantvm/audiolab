...
from dsp_lab.autoresearch.action_map import ActionSpec, tunable_paths_for_action
...
from dsp_lab.experiments.param_utils import apply_param_values, get_graph_param, load_graph_dict
from dsp_lab.experiments.tunable_validation import validate_calibration_task_tunables, validate_tunable_path
from dsp_lab.graph.executor import render_graph
from dsp_lab.graph.schema import GraphSpec
from dsp_lab.parallel import ParallelWorkerPool, parallel_map, resolve_trial_batch_size
...
def run_targeted_calibration(
    ...
    if not refs_ok:
        return {
            ...
            "reason": reason,
            "manual_command": (
                f"PYTHONPATH=src python -m dsp_lab.experiments.calibration "
