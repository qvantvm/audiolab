...
from dsp_lab.autoresearch.action_map import action_map_snapshot
from dsp_lab.autoresearch.agent_cycle_report import build_agent_cycle_report, write_agent_cycle_report
from dsp_lab.autoresearch.calibration_plan import (
...
from dsp_lab.autoresearch.experiment_design.run import load_active_learning_summary
...
from dsp_lab.autoresearch.cluster_selection import (
    find_cluster_by_id,
...
from dsp_lab.autoresearch.hypothesis import build_hypothesis_from_cluster, build_hypothesis_markdown
from dsp_lab.autoresearch.hypothesis_validator import (
    HypothesisValidationError,
    parse_supervisor_hypothesis,
    validate_structured_hypothesis,
)
from dsp_lab.autoresearch.journal import append_journal_entry, build_journal_markdown_entry, read_journal_history
from dsp_lab.governance.integration import run_cycle_governance
from dsp_lab.autoresearch.planner_audit import write_planner_audit
from dsp_lab.autoresearch.planner_client import make_planner
from dsp_lab.autoresearch.planner_context import build_planner_context
from dsp_lab.autoresearch.planner_prompt import build_planner_prompt
from dsp_lab.autoresearch.proposal_schema import parse_planner_response
from dsp_lab.autoresearch.proposal_selection import (
    build_deterministic_fallback_proposal,
    build_selection_record,
)
from dsp_lab.autoresearch.proposal_validator import validate_proposals
from dsp_lab.autoresearch.safety_checks import safety_check_passed
from dsp_lab.autoresearch.subset_builder import (
...
def _run_planner_stage(
    ...
    *,
    ...
    if config.memory.use_for_proposal_ranking and memory_state.get("enabled"):
        ...
        from dsp_lab.autoresearch.proposal_selection import select_valid_proposal
...
def run_autoresearch_cycle(
    ...
    *,
    ...
    if structured_hyp is not None:
        from dsp_lab.autoresearch.graph_resolution import tunable_block_id_for_hypothesis
