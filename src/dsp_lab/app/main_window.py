...
from dsp_lab.app.edit_dialogs import AddBlockDialog, BlockBrowserDialog, ConnectionDialog
...
class MainWindow(QMainWindow):
    ...
    def calibrate_current(self) -> None:
        ...
        from dsp_lab.experiments.param_utils import extract_calibration_task
    ...
    def play_render(self) -> None:
        ...
        if self.audio_player is None:
            ...
            return
        target = Path(tempfile.gettempdir()) / f"dsp_lab_preview_{id(self)}.wav"
